...
(function(f) {
    ...
    var regexs = {
         ...
         * 国际码 如：中国(+86)
         */
        phone: /^((\+?[0-9]{1,4})|(\(\+86\)))?(13[0-9]|14[57]|15[012356789]|17[035678]|18[0-9])\d{8}$/,
        /**
         * @descrition 匹配 URL
         */
        url: /[a-zA-z]+:\/\/[^\s]/,
    ...
    var _testHook = {
        // 验证密码
        is_password: function(field) {
            if(field.value.trim().length<=0){
                return true;
            }
            return regexs.password.test(backVal(field));
        },
        // 验证合法邮箱
    ...
    var Validator = function(formelm, fields, callback) {
        ...
        for (var i = 0, fieldLength = fields.length; i < fieldLength; i++) {
            ...
            if(fieldName.indexOf("|")>=0){
                for (var n=0;n<fieldName.split("|").length;n++){
                    field.name = fieldName.split("|")[n];
    ...
    Validator.prototype = {
        ...
        validate: function(evt) {
            ...
            if (typeof this.callback === "function") {
                //this.callback(this, evt); 2019-09-11 majun
                if(this.errors.length>0){
                    // 判断是否错误
                    for (var i = 0; i < this.errors.length; i++) {
                      var msg = this.errors[i].message
                        swal({title:"提示",text:msg,type: "warning"})
                        break ;
                    }
                }
            }
